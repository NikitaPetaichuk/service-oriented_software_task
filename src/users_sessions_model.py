...
class UsersSessionsModel:
    ...
    def __init__(
        ...
        with self.db_connection.cursor() as cursor:
            cursor.execute(UsersDBCommands.CREATE_SESSIONS_HISTORY_TABLE_COMMAND)
    ...
    def _archive_session(self, auth_key, auth_data):
        with self.db_connection.cursor() as cursor:
            cursor.execute(UsersDBCommands.INSERT_SESSION_COMMAND, (auth_key, auth_data))
        self.db_connection.commit()
